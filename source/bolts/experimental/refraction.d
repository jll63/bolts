...
Function[] refract(alias Scope, string localSymbol, alias Predicate = True)()
  if (isScope!Scope)
{
  Function[] functions;
...
immutable struct Function
{
  ...
  */
  ...
  Function setParameters(immutable(Parameter)[] value)
  {
  ...
  */
  ...
  Function setUdas(immutable(string)[] value)
  {
...
immutable struct Parameter
{
  ...
  */
  ...
  Parameter setStorage(immutable(string)[] value)
  {
  ...
  */
  ...
  Parameter setUdas(immutable(string)[] value)
  {
    mixin replaceAttribute!"udas";
    return copy;
  }
